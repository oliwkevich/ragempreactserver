...
interface DatabaseMp {}
declare abstract class DatabaseMp {
	accounts;
	openConnection(): void;
	closeConnection(): void;
	makeTransaction(async callback: (...args: any[]) => void): void;
}

interface UserMp {}
declare abstract class UserMp {
	_player: PlayerMp;
	// uid: number; 
	// login: string;
	// money: number;
    ...
    teleport: (Vector3Mp: Vector3Mp) => void;
}
