...
interface CamerasModuleMp {
	createCamera(name: string, position: Vector3Mp): void;
	setCameraActive(name: string, easeIn: boolean): void;
	setCameraEntity(name: string, entity: PlayerMp): void;
	setCameraPosition(name: string, position: Vector3Mp): void;
	setCameraLookAt(name: string, position: Vector3Mp): void;
	setCameraInterpolate(name: string, position: Vector3Mp, pointAt: Vector3Mp, duration: number): void;
	destroyCamera(name: string): void;
	setCameraRot(name: string, rot: {x: number, y: number, z: number}): void;
	getCameraRot(name: string): void;
}
...
interface EventMpPool {
	...
	addProc(eventProcName: string, callback: (...args: any[]) => void): void;
